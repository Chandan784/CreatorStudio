    ...
    <div className="min-h-screen bg-gray-100 pb-20">
      ...
      <section className="mt-4">
        <div className="relative rounded-lg overflow-hidden mx-4">
          <img src="/assets/images/equipment/image.jpg" alt="Banner" className="w-full h-40 object-cover" />
      ...
      <section className="mt-6 mx-4">
        ...
        <div className="grid grid-cols-2 gap-4 mt-4">
          ...
          <EquipmentCard title="Mirrorless Camera" price="$69.69" img="/assets/images/equipment/download.jpg"/>
          <EquipmentCard title="Microphone" price="$49.99" img="/assets/images/equipment/download 1.jpg"/>
