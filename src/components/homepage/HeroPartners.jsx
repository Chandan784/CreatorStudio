    ...
    return (
        <div className='bg-[#f3f5f7]'>
            <div className="max-w-[1200px] px-4 mx-auto xl:px-0 py-16 md:py-[70px] lg:py-20">
                        ...
                        return (
                            <div className="bg-white shadow-md rounded-md hover:scale-[1.02] overflow-hidden duration-300" key={i}>
                                ...
                                <div className="p-6 relative">
                                    <button onClick={() => setShowPopUp(true)} className='bg-black -top-[18px] absolute block text-white p-1 leading-none text-base font-bold'>Play Button</button>
                ...
                {showPopUp && <PopUp showPopUp={showPopUp} setShowPopUp={setShowPopUp} heading="SuccessFull"
                    subheading="Thank you for your interest in joining us. Our representative will contact you within the next 12 hours."
                />}
            </div>
        </div>
    )
